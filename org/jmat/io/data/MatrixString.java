...
public class MatrixString {
  ...
  public static String printMatrix(Matrix m) {
    return MatrixString.printMatrix(m,' ');
  }

  public static String printMatrix(Matrix m, char delimiter) {
   ...
   */
   ...
   public static Matrix readMatrix (String s,char delimiter) {
    try {
