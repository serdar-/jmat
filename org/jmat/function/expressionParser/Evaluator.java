...
//		System.out.println(n.getString());
	...
	private static Object evaluateExpression1(Operator o, Object o1)	{
		...
		if (o1isMatrix) {
			...
			else if  ( "diag".equals(op) )  	res = (Object)(f1.getDiagonal()) ;
			else if  ( "det".equals(op) )  	  res = (Object)(new Double((double)(f1.determinant()))) ;
			...
			else if  ( "prod".equals(op) )  	res = (Object)(f1.product()) ;
			...
			else if  ( "cov".equals(op) )  	  res = (Object)(((RandomMatrix)(f1)).covariance()) ;
			else if  ( "var".equals(op) )  	  res = (Object)(((RandomMatrix)(f1)).variance()) ;
			else if  ( "cor".equals(op) )  	  res = (Object)(((RandomMatrix)(f1)).correlation()) ;
		...
		private void init(Node parent, String s, int level) throws Exception		{
			...
			if ( nOperator != null )			{
				...
				// two operands
					...
					if ( startOperator > 0 && nOperator.getType() == 2 )				{
						nOperator = nOperator;
...
//					System.out.println("Operator found : " + operators[i].getOperator());
					return operators[i];
				}
