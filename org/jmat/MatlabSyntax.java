...
////////////////////////////////////////////////////////////
   ...
   */
   ...
   public static void set (Matrix A, int i0, int i1, int j0, int j1, Matrix X) {
	  X.checkMatrixDimensions(i1-i0,j1-j0);
	   A.setMatrix(i0-1,j0-1,X);
  }
...
////////////////////////////////////////
   ...
   */
   ...
   public static Matrix cov (Matrix A) {
	  return new RandomMatrix(A).covariance();
   }
   ...
   */
   ...
   public static Matrix corrcoef (Matrix A) {
	  return new RandomMatrix(A).correlation();
   }
   ...
   */
   ...
   public static Matrix var (Matrix A) {
	  return new RandomMatrix(A).variance();
   }
...
/////////////////////////////////////////////////////////
  ...
  public static Matrix load(String fileName) {
	return Matrix.fromFile(new File(fileName));
  }

   /** Plot the Matrix in a JFrame
   @param X    Matrix.
   @param n    Number of slices.
   @return      A MatrixPlot2DPanel (extends a Swing JPanel)
   */
   /*M
   <syntax>
  ...
  public static Plot2DPanel hist(Matrix X, int n) {
	return new RandomMatrix(X).slice(10).getSlicedMatrix().toPlot2DFrame("","",PlotPanel.HISTOGRAM);
  }
  ...
  public static Plot2DPanel hist(String title, Matrix X, int n) {
	return new RandomMatrix(X).slice(10).getSlicedMatrix().toPlot2DFrame("",title,PlotPanel.HISTOGRAM);
  }
  ...
  public static Plot2DPanel plot(Matrix X, Matrix Y) {
	return X.mergeColumns(Y).toPlot2DFrame("","",PlotPanel.SCATTER);
  }
  ...
  public static Plot2DPanel plot(String title, Matrix X, Matrix Y) {
	return X.mergeColumns(Y).toPlot2DFrame("",title,PlotPanel.SCATTER);
  }
   ...
   @param Y    Matrix
   @param Z    Matrix
   @return      A MatrixPlot3DPanel (extends a Swing JPanel)
   */
   /*M
   <syntax>
  ...
  public static Plot3DPanel plot3(Matrix X,Matrix Y,Matrix Z) {
	return X.mergeColumns(Y).mergeColumns(Z).toPlot3DFrame("","",PlotPanel.SCATTER);
  }
  ...
  public static Plot3DPanel plot3(String title,Matrix X,Matrix Y,Matrix Z) {
	return X.mergeColumns(Y).mergeColumns(Z).toPlot3DFrame("",title,PlotPanel.SCATTER);
  }
